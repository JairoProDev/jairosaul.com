 ...
 * 2. Rellenar el mapa $HREFLANG_MAPA idéntico en las tres instalaciones.
 * 3. Verificar con: curl -s URL | grep hreflang
 * 4. Verificar reciprocidad con auditor_seo.py y luego en el informe de
 ...
 *
 * Genera este array desde tu hoja de cálculo de equivalencias — no lo escribas
 * a mano URL por URL si tienes 60 tours.
 */
$HREFLANG_MAPA = array(

	// --- Home ---
	array(
		'en'    => 'https://www.ejemplo-en.com/',
		'es'    => 'https://www.ejemplo-es.com/',
		'pt-BR' => 'https://www.ejemplo-pt.com/',
	),

	// --- Ejemplo: un tour presente en los tres catálogos ---
	array(
		'en'    => 'https://www.ejemplo-en.com/tour/sacred-valley-tour/',
		'es'    => 'https://www.ejemplo-es.com/tour/valle-sagrado/',
		'pt-BR' => 'https://www.ejemplo-pt.com/pacote/vale-sagrado/',
	),

	// Añade aquí un grupo por cada equivalencia.
);
