...
excerpt: "Ningún cliente de esa empresa lee devanagari. Google Fonts igual lo descarga. El LCP de texto espera a la fuente. El layout salta cuando llega. Es un archivo de configuración, no un rediseño."
related:
...
En un `traveltour` de Goodlayers medí Poppins en **dieciocho variantes** (100 a 900, normal e italic) más DM Sans, con subset `devanagari`. Devanagari es el alfabeto del hindi y el sánscrito. El viajero de esa red lee latín: inglés, español, portugués, italiano. El subset sobra. Los pesos 100, 200 y 900 italic también, si el CSS no los usa.
