...
excerpt: "Disallow con https://…, Disallow: //wp-includes/, Disallow: */page/*. Tres líneas que parecen política y no hacen lo que el autor creía. Sitemap: faltaba en dos de tres idiomas."
related:
...
Tres errores que encontré en producción, en la misma red, el mismo día:
...
Cuando heredas un WordPress con Yoast, el archivo es una mezcla de Yoast + alguien que pegó reglas de un foro. Tu trabajo de semana 1 es leerlo en los cuatro dominios. Van a diferir. Eso, en una “red”, es el síntoma: nadie es dueño del rastreo.
